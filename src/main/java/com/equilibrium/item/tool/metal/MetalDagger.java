...
public class MetalDagger extends TieredItem implements AdditionalAttribute{
    public MetalDagger(Tier toolMaterial, Item.Properties settings) {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag type) {
        ...
        tooltip.add(Component.translatable("item.miteequilibrium.dagger_tooltip").withStyle(ChatFormatting.GRAY));
