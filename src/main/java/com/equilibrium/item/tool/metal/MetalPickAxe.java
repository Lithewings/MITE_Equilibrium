...
public class MetalPickAxe extends TieredItem implements AdditionalAttribute {


    public MetalPickAxe(Tier material, Properties settings) {
        super(material,settings.component(DataComponents.TOOL,material.createToolProperties(BlockTags.MINEABLE_WITH_PICKAXE)));
    }
