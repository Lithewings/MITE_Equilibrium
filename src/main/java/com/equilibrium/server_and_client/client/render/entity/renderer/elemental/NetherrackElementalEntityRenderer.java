...
public class NetherrackElementalEntityRenderer extends AbstractEarthElementalEntityRenderer<NetherrackElementalEntity> {
    public NetherrackElementalEntityRenderer(EntityRendererProvider.Context ctx, BaseEarthElementalEntityModel<NetherrackElementalEntity> model, float shadowRadius) {
        super(ctx, model, shadowRadius);
    }
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MOD_ID,"textures/entity/netherrack_elemental.png");
    @Override
    public ResourceLocation getTextureLocation(NetherrackElementalEntity entity) {
        return TEXTURE;
    }
