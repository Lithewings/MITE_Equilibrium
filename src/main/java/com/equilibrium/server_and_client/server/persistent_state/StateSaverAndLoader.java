...
public class StateSaverAndLoader extends SavedData {
    ...
    public CompoundTag mapNbt1=new CompoundTag();


    public CompoundTag mapNbt2=new CompoundTag();
...
//        stateSaverAndLoader.keepHardcore = tag.getBoolean("keepHardcore");
    ...
    public static StateSaverAndLoader getServerState(MinecraftServer server) {
        ...
        //读入所有nbt变量
        StateSaverAndLoader state = persistentStateManager.computeIfAbsent(type, MOD_ID);
