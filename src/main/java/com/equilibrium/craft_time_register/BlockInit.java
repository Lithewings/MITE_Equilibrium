...
public class BlockInit {
    ...
    public static void registerBlocks() {
        ...
        Registry.register(Registries.BLOCK, Identifier.of(MITEequilibrium.MOD_ID, "silver_crafting_table"), SILVER_CRAFTING_TABLE);
    ...
    public static void registerBlockItems() {
        ...
        Registry.register(Registries.ITEM, Identifier.of( MITEequilibrium.MOD_ID, "silver_crafting_table"), new BlockItem(SILVER_CRAFTING_TABLE, new Item.Settings().fireproof()));
