...
public class AdamantiumAnvilScreen extends ForgingScreen<AdamantiumScreenHandler> {
    ...
    public AdamantiumAnvilScreen(AdamantiumScreenHandler handler, PlayerInventory inventory, Text title) {
