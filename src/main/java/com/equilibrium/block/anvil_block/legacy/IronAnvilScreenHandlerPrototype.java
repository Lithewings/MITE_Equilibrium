...
//
//
//public class IronAnvilScreenHandlerPrototype extends ForgingScreenHandler {
...
//    protected int repairItemUsage;
//    @Nullable
//    private String newItemName;
//    protected final Property levelCost = Property.create();
...
//
//
//    public IronAnvilScreenHandlerPrototype(int syncId, PlayerInventory inventory) {
//        this(syncId, inventory, ScreenHandlerContext.EMPTY);
//    }
//
//    public IronAnvilScreenHandlerPrototype(int syncId, PlayerInventory inventory, ScreenHandlerContext context) {
...
//        return state.isOf(ModBlocksRegistry.IRON_ANVIL);
//    }
//
//    @Override
...
//
//    //修复等级要求最大为52级
//    protected static int getNextCost(int cost) {
