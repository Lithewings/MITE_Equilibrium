...
//
//
//public class IronAnvilBlock2 extends FallingBlock{
//    public static final MapCodec<IronAnvilBlock2> CODEC = createCodec(IronAnvilBlock2::new);
//    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;
//    protected static final VoxelShape BASE_SHAPE = Block.createCuboidShape(2.0, 0.0, 2.0, 14.0, 4.0, 14.0);
//    protected static final VoxelShape X_STEP_SHAPE = Block.createCuboidShape(3.0, 4.0, 4.0, 13.0, 5.0, 12.0);
//    protected static final VoxelShape X_STEM_SHAPE = Block.createCuboidShape(4.0, 5.0, 6.0, 12.0, 10.0, 10.0);
//    protected static final VoxelShape X_FACE_SHAPE = Block.createCuboidShape(0.0, 10.0, 3.0, 16.0, 16.0, 13.0);
//    protected static final VoxelShape Z_STEP_SHAPE = Block.createCuboidShape(4.0, 4.0, 3.0, 12.0, 5.0, 13.0);
//    protected static final VoxelShape Z_STEM_SHAPE = Block.createCuboidShape(6.0, 5.0, 4.0, 10.0, 10.0, 12.0);
//    protected static final VoxelShape Z_FACE_SHAPE = Block.createCuboidShape(3.0, 10.0, 0.0, 13.0, 16.0, 16.0);
//    protected static final VoxelShape X_AXIS_SHAPE = VoxelShapes.union(BASE_SHAPE, X_STEP_SHAPE, X_STEM_SHAPE, X_FACE_SHAPE);
//    protected static final VoxelShape Z_AXIS_SHAPE = VoxelShapes.union(BASE_SHAPE, Z_STEP_SHAPE, Z_STEM_SHAPE, Z_FACE_SHAPE);
//    //    private static final Text TITLE = Text.translatable("container.repair");
//    protected static final Text TITLE = Text.of("模组铁砧屏幕");
//    protected static final float FALLING_BLOCK_ENTITY_DAMAGE_MULTIPLIER = 2.0F;
//    protected static final int FALLING_BLOCK_ENTITY_MAX_DAMAGE = 40;
//
//    @Override
//    public MapCodec<IronAnvilBlock2> getCodec() {
//        return CODEC;
//    }
//
...
//
//    public IronAnvilBlock2(Settings settings) {
//        super(settings);
...
//                (syncId, inventory, player) -> new IronAnvilScreenHandler2(syncId, inventory, ScreenHandlerContext.create(world, pos)), TITLE
//        );
//    }
//
//    //掉落物品的耐久是什么?
...
//                //copy facing
//                .with(IronAnvilBlock2.FACING, state.get(IronAnvilBlock2.FACING))
//                //copy damage
