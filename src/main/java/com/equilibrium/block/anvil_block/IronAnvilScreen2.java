...
public class IronAnvilScreen2 extends ForgingScreen<IronAnvilScreenHandler2> {
    ...
    public IronAnvilScreen2(IronAnvilScreenHandler2 handler, PlayerInventory inventory, Text title) {
