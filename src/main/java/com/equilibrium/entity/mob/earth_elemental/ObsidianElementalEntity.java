...
public class ObsidianElementalEntity extends AbstractEarthElementalEntity {
    ...
    public ObsidianElementalEntity(EntityType<? extends Monster> entityType, Level world, Block material) {
    ...
    public ResourceKey<LootTable> getDefaultLootTable() {
        return ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(MOD_ID, "entity/obsidian_elemental"));
    }
}
