...
public class EndRockElementalEntity extends AbstractEarthElementalEntity {
    ...
    public EndRockElementalEntity(EntityType<? extends HostileEntity> entityType, World world, Block material) {
    ...
    public RegistryKey<LootTable> getLootTableId() {
        return RegistryKey.of(RegistryKeys.LOOT_TABLE, Identifier.of(MOD_ID, "entity/end_rock_elemental"));
    }
}
