...
public class NetherrackElementalEntity extends AbstractEarthElementalEntity {
    ...
    public NetherrackElementalEntity(EntityType<? extends Monster> entityType, Level world, Block material) {
    ...
    public ResourceKey<LootTable> getDefaultLootTable() {
        return ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(MOD_ID, "entity/netherrack_elemental"));
    }
}
