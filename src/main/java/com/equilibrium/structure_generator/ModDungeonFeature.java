...
//    private static final EntityType<LongDeadEntity> longDeadEntityEntityType  = EntityType.Builder.create(LongDeadEntity::new, SpawnGroup.MONSTER).build();
    ...
    public ModDungeonFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
                ...
                for (int t = 0; t < 3; t++) {
                    ...
                    if (structureWorldAccess.isAir(blockPos3)) {
                        ...
                        if (x == 1) {
                            ...
                            LootableInventory.setLootTable(structureWorldAccess, random, blockPos3,RegistryKey.of(RegistryKeys.LOOT_TABLE, Identifier.of(MOD_ID,"chests/simple_dungeon")));
                            break;
                        }
                    }
                }
